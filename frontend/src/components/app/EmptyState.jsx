...
export default function EmptyState({ icon: Icon = Inbox, title, description, actionLabel, onAction, testid }) {
  return (
    <div
      ...
      className="flex flex-col items-center justify-center text-center py-16 px-6 bg-white border border-dashed border-gray-300 rounded-xl"
    >
      <div className="w-16 h-16 rounded-2xl bg-[#0A3B2C]/8 text-[#0A3B2C] flex items-center justify-center mb-5">
